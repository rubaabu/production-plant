            ...
            <div id="ru-row" class="row justify-content-center align-items-center">
                <div id="ru-column" class="col-md-6">
                    <div id="ru-box" class="col-md-12">
                        <form id="myForm" action ="delete_Emp.php" method="post">
                        <h3 style=" color: #d8dfe2" class="text-center ">Delete ?</h3>

                        <div class="form-group">
            <input type="hidden" name="id" value="<?php echo $data['employee_id'] ?>" />
            <button id="submit" class="btn btn-info btn-md" type="submit">Yes, delete it!</button >
           
            <a href="../employees.php"><button class="btn btn-info btn-md" type="button">No, go back!</button ></a>
            </div>
